...
<div id="tab-redeem-code" class="flex h-full min-h-0 flex-col text-sm">
			...
			{#if result}
				<div class="rounded-lg border border-gray-100 p-3 dark:border-gray-850">
					<div class="text-[13px] font-medium">
						{result.tier_after ?? result.subscription?.tier}
					</div>
					<div
						class="mt-2 grid grid-cols-2 gap-2 text-[0.6875rem] text-gray-600 dark:text-gray-300"
					>
