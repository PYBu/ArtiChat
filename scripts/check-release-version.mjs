...
if (!about.includes('WEBUI_VERSION') || !about.includes('DEFAULT_ABOUT_TITLE')) {
	failures.push('About page must render the semantic WEBUI_VERSION in its default title');
}
