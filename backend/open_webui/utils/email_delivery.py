    ...
    *,
    ...
    if enabled and username:
        ...
        try:
            ...
            raise ValueError('SMTP_PASSWORD_REENTER_REQUIRED') from exc
        ...
        with transport as client:
            ...
            if username:
                try:
                    ...
                    code = str(exc)
                    if code == 'SMTP_PASSWORD_DECRYPT_FAILED':
                        code = 'SMTP_PASSWORD_REENTER_REQUIRED'
                    raise SMTPStageError('config', code) from exc
                try:
