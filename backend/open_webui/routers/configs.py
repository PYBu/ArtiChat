...
from open_webui.utils.platform import normalize_platform_settings, platform_about_defaults, save_platform_logo
...
async def platform_settings() -> dict:
    ...
    return {
        ...
        'about_title': values.get('about_title') or about_defaults['about_title'],
        'about_content': values.get('about_content') or about_defaults['about_content'],
