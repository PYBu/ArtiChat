...
def test_debit_caps_payment_at_available_balance():
    ...
    assert result.check_cost_micros == 250_000
    assert result.plan_balance_after_micros == 0
    assert result.check_balance_after_micros == 0
    assert result.unpaid_cost_micros == 250_000
